...
class GraphNode():
    ...
    def connect(self, dest_node, weight=1):
        ...
        # if the edge does not already exist, add it to the dictionary of edges
    ...
    def connected(self, dest_node):
        ...
        # if in dictionary than return true, else return false
        if dest_node in self.edges:
            return True
        else:
            return False
        # raise NotImplementedError
    ...
    def disconnect(self, dest_node):
        ...
        # delete the key from the dictionary of edges
        else:
            del self.edges[dest_node]
    ...
    def all_edges(self):
        ...
        # .items() returns dictionary values in tuple form
        #return self.edges.items()
        keyList = list(self.edges.keys())
        for key in keyList:
            yield (key, self.edges[key])
        #raise NotImplementedError
    ...
    def del_all_edges(self):
        ...
        """
        # creating a list of the dest-nodes
        keyList = list(self.edges.keys())
        for key in keyList:
            # removing each key in the dictionary one by one by iterating list
            del self.edges[key]
        #raise NotImplementedError
